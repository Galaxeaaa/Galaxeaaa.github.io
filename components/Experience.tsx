	...
	return (
		<div className="flex">
			...
			<div className="flex flex-col w-10 flex-shrink-0 items-center mr-4">
				<div>
					{current === true ?
						<div className="absolute w-10 h-10 border-[3px] rounded-full border-color-accent-1-light animate-ping"></div>
						: null}
					<div className="flex items-center justify-center w-10 h-10 border-[3px] rounded-full border-color-accent-1-light">
						{(() => {
							switch (catagory) {
								case "education":
