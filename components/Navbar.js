		...
		<div className="max-w-7xl mx-auto px-10 py-10 md:py-20">
			<div className="flex flex-row justify-between items-center overflow-hidden">
				...
				<div className="flex flex-row items-center space-x-6">
					<div className="hidden space-x-8 justify-self-center md:flex text-xl">
						<Link href="/about">
							<a
						...
						<Link href="/projects">
							<a
								className={`${router.asPath === "/projects"
									? "text-gray-800 font-bold dark:text-gray-400"
									: "text-gray-600 dark:text-gray-300 font-normal "
									}`}
							>
						...
						<Link href="/experience">
							<a
								className={`${router.asPath === "/experience"
									? "text-gray-800 font-bold dark:text-gray-400"
									: "text-gray-600 dark:text-gray-300 font-normal "
									}`}
							>
			...
			<div className="flex justify-center space-x-8 md:hidden mt-4 text-xl">
				<Link href="/about">
					<a className="font-normal text-gray-600 dark:text-gray-300">
						About
					</a>
				</Link>
				<Link href="/projects">
