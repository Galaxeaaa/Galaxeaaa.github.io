		...
		<div className="bg-white/90 backdrop-blur border-b w-full transition-colors duration-500">
			<div className="py-4 px-10 max-w-6xl mx-auto">
				<div className="flex items-center text-lg font-normal space-x-2">
					<h onClick={() => scroll.scrollToTop({ duration: 1 })} className="cursor-pointer text-xl font-bold text-indigo-500 underline decoration-4 decoration-emerald-300 mr-4">
						Cheng Wang
					</h>
					<ScrollLink to="about" spy={true} offset={-50}>
						<h className="cursor-pointer text-gray-700 hover:text-indigo-700 hover:bg-indigo-500/20 transition-all ease-in-out px-4 py-2 rounded-lg" >
							About
						</h>
					</ScrollLink>
